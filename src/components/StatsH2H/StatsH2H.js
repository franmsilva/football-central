  ...
  <div className="h2hstats">
    <div className="h2hstats__container">
      <div
        ...
        style={{
          width: `${(stats['last_h2h'].wins.total / stats['last_h2h'].played.total) * 100}%`,
        }}
      >
      ...
      <div
        ...
        style={{
          width: `${(stats['last_h2h'].draws.total / stats['last_h2h'].played.total) * 100}%`,
        }}
      >
      ...
      <div
        ...
        style={{
          width: `${(stats['last_h2h'].loses.total / stats['last_h2h'].played.total) * 100}%`,
        }}
      >
