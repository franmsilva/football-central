...
const Fixture = () => {
  ...
  useEffect(() => {
    ...
    footballAPI.getPredictions(fixtureID).then((predictions) => setPredictions(predictions));
    footballAPI.getFixtureData(fixtureID).then((fixture) => {
