          ...
          <div className="predictions__container">
            <div className="predictions__container__4">
              <div className="predictions__container__2">
                <p>
                  <span>Match Winner:</span> {getMatchWinner(predictions['match_winner'])}
                </p>
                <p>
              ...
              <div className="predictions__container__2">
                <p>
                  ...
                  {predictions['goals_home']
                    ? predictions['goals_home']
                    : 'No Prediction Available'}
                </p>
                <p>
                  <span>Goals Away:</span>{' '}
                  {predictions['goals_away']
                    ? predictions['goals_away']
                    : 'No Prediction Available'}
                </p>
              </div>
            ...
            <p className="advice">
              <span>Advice:</span>{' '}
              {predictions['advice'] ? predictions['advice'] : 'No Prediction Available'}
            </p>
          </div>
          <h1>Last 5 Matches</h1>
          <Last5Stats
            homeTeam={predictions.teams.home['last_5_matches']}
            awayTeam={predictions.teams.away['last_5_matches']}
          />
          <h1>H2H Record</h1>
