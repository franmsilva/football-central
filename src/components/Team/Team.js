...
const Team = () => {
  ...
  useEffect(() => {
    ...
    footballAPI.getTeamInfo(teamID).then((team) => setTeamInfo(team));
    newsAPI.getTeamNews(teamName).then((news) => setTeamNews(news));
    footballAPI.getTeamFixtures(teamID, leagueID).then((fixtures) => setTeamFixtures(fixtures));
    footballAPI
      .getPlayerStatistics(teamID, '2019-2020', leagueName.replace('-', ' '))
        ...
        <React.Fragment>
          <div className="team__header">
            <div className="team__logo">
              <Image alt="Home Team Logo" src={teamInfo.logo} width={100} />
            </div>
